...
self.location=' frm_zero_stock.php?region=' + val ;
}
...
self.location=' frm_zero_stock.php?region=' + val + '&branch=' + val2 ;
}
...
self.location=' frm_zero_stock.php?region=' + val + '&branch=' + val2 + '&dgp=' + val3 ;
}
...
<form method="post" name='f1' action='<?php echo "../modules/mod_zero_stk.php?usertype=".$user_type;?>'>
...
<tr><td valign="top" ><br />
	...
	<table border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="rFont10">
		  <tr>
			<td colspan="2" bgcolor="#FF8306" valign="middle" class="head_text" height="25">&nbsp;<strong>Zero Stock</strong></td>
		  </tr>
		  <tr >
...
<input type="hidden" name="user_id" id="user_id" value="<?php echo $_SESSION['sess_user']; ?>"/>
</form>

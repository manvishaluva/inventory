...
self.location='frm_account_transcation.php?branch=' + val ;
}
...
<form method="post" name='frm1' action="frm_view_account_details.php">
...
<tr><td valign="top" ><br />
	...
	<table border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="rFont10">
		  <tr>
			<td colspan="2" bgcolor="#FF8306" valign="middle" class="head_text" height="25">&nbsp;<strong>Account Transfer</strong></td>
		  </tr>
		  <tr >

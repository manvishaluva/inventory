...
<body>
<br />
<form method="post" action="../modules/mod_add_division_groups.php" name="frm1">
...
<tr height="50px;"><td width="100%" ></td></tr>
  ...
  <tr>	<td colspan="2" bgcolor="#eb5aa3" height="30" valign="middle" class="head_text_admin" ><strong><?php echo $head;?>Division Group Name</strong></td>
				  </tr>
                  <?php
            if($msg!=''){
			?>
           ...
           <?php
			...
			?>
				  ...
				  <tr>
					...
					&nbsp;<input type="button" name="cancel" class="top_border" value="Cancel" onclick="location.href='frm_view_division_groups.php'"/>

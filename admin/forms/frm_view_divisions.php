...
function DeleteUser(id){
  	if(confirm("Are you sure you want to delete this division?")){
		location.href='../../modules/delete.php?tbl=tbl_divisions'+'&cond=division_id='+id+'&url=../admin/forms/frm_view_divisions.php';
	}
}
</script>
  ...
  <tr>
    <td><table width="1300 px" border="0" cellspacing="0" cellpadding="0">
      <tr height="620 px">
        ...
        <td width="1047" bgcolor="#FFFFFF"><table border="0" align="center" cellpadding="3">
          <tr>
          ...
          <tr>
            <td colspan="7" bgcolor="#eb5aa3"  class="head_text_admin" height="25">Divisions</td>
          </tr>
          ...
          <tr bgcolor="#000000">
			...
			<td  class="style3" height="25" align="center"   width="100" nowrap="nowrap"> Action</td>
             ...
             <?php
                $row_count=1;
                $SQL_Query = "SELECT * FROM tbl_divisions ORDER BY region_id";
		 ...
		 <tr height="20"<?php if($row_count%2==0) echo 'bgcolor="#F7F7F7"';?> >
            ...
            <td   align="left" bordercolor="#E9E9E9" class="text1"><?php echo $row_user['division_name'] ?></td>
           
			<td align="center" bordercolor="#E9E9E9" nowrap="nowrap" class="text1">  
				<a href="frm_add_division.php?division_id=<?php echo $row_user['division_id'];?>" >
				<img src="../images/icon_edit.gif" border="0" /></a>&nbsp;
				<a href="javascript:DeleteUser(<?php echo $row_user['division_id']?>);">
           ...
           ?>
			...
			<td colspan="6" nowrap="nowrap" class="navigate"><?php echo $pager->renderFullNav(); ?>															            </td>
                       			 ...
                       			 <?php }else{?>
            <tr>
			<td colspan="4" align="center" height="30px"  class="red">No Divisions</td>
			</tr>
			  <?php }
           ?>
		   ...
		   <tr>
			   <td class="top_border" colspan="7" align="right" height="30" bgcolor="#EEEEEE">
					<input type="button" class="top_border" value="Add New Division" onClick="location.href='frm_add_division.php?flag=1'" /></td>
		   </tr>

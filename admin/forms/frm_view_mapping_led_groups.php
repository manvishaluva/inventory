...
<title>Mis - Admin - Division mapping</title>
<script>
function DeletePageSection(id){
  	if(confirm("Are you sure you want to delete this Group?")){
		location.href='../../modules/delete.php?tbl=tbl_ledger_group_mapping'+'&cond=mapping_id='+id+'&url=../admin/forms/frm_view_mapping_led_groups.php';
	}
}
</script>
<style type="text/css">
...
<tr height="50px;"><td width="100%" ></td></tr>
        ...
        <table border="0" align="center" cellpadding="3">
          <tr><td bgcolor="#eb5aa3">
            ...
            <tr>
              <td colspan="3"   height="25" valign="middle" bgcolor="#eb5aa3" class="head_text_admin"><strong>Mapping Ledger Group Name</strong> </td>
              </tr>
              <tr bgcolor="#000000">
             ...
             <?php
                $row_count=1;
                $SQL_Query = "SELECT * FROM tbl_ledger_group_mapping";
				$pager = new PS_Pagination($conn, $SQL_Query, 20, 200, "param1=valu1&param2=value2");
				$pager->setDebug(true);
				$rs = $pager->paginate();
				$rows=mysql_query("SELECT * FROM `tbl_ledger_group_mapping`");
             ...
             ?>
              <tr <?php if($row_count%2==0) echo 'bgcolor="#F7F7F7"'; ?>  >
                <td width="68%" class="text1" align="left"><strong><?php echo $row_user['mapping_group_name'];?></strong></td>
                <td align="center">
				
                  
				  <a href="javascript:DeletePageSection(<?php echo $row_user['mapping_id']?>);">
           ...
           ?>
              <tr><td height="30" colspan="3" align="right" bgcolor="#EEEEEE" class="top_border">
			    <input class="top_border" type="button" value="Add Group Name" onclick="location.href='frm_add_mapping_led_groups.php'" />

...
function DeleteUser(id){
  	if(confirm("Are you sure you want to delete this Entry?")){
		location.href='../../modules/delete.php?tbl=tbl_sub_branches'+'&cond=id='+id+'&url=../admin/forms/frm_view_sub_branch.php';
	}
}
</script>
    ...
    <td><table width="1300 px" border="0" cellspacing="0" cellpadding="0">
      <tr height="620 px">
        ...
        <tr height="90">
          ...
          <tr>
            <td colspan="7" bgcolor="#eb5aa3"  class="head_text_admin" height="25">Sub Branches</td>
          </tr>

          <tr bgcolor="#000000">
            
            <td  class="style3" height="25" align="left" >Branch</td>
            <td  class="style3" height="25" align="left"  >Sub Branch</td>
			<td  class="style3" height="25" align="center"   width="100" nowrap="nowrap"> Action</td>
          </tr>
             <?php
                $row_count=1;
                $SQL_Query = "SELECT * FROM tbl_sub_branches order by branch_id";
				...
				$rs = $pager->paginate();
                    ...
                    while($row_user=mysql_fetch_assoc($rs))
                    {
						...
						$sql_branch="select branch_name from tbl_branch_master where  branch_id=".$row_user['branch_id'];
		 ...
		 <tr height="20"<?php if($row_count%2==0) echo 'bgcolor="#F7F7F7"';?> >
            ...
            <td   align="left" bordercolor="#E9E9E9" class="text1"><?php echo $row_user['sub_branch_name'] ?></td>
           
			<td align="center" bordercolor="#E9E9E9" nowrap="nowrap" class="text1">  
				
				<a href="javascript:DeleteUser(<?php echo $row_user['id']?>);">
           ...
           ?>
			...
			<td colspan="6" nowrap="nowrap" class="navigate"><?php echo $pager->renderFullNav(); ?>															            </td>
                       			 ...
                       			 <?php }else{?>
            <tr>
			<td colspan="4" align="center" height="30px"  class="red">No Sub Branches</td>
			</tr>
			  <?php }
           ?>
		   ...
		   <tr>
			   <td class="top_border" colspan="7" align="right" height="30" bgcolor="#EEEEEE">
					<input type="button" class="top_border" value="Add Sub Branch" onClick="location.href='frm_add_sub_branch.php?flag=1'" /></td>
		   </tr>

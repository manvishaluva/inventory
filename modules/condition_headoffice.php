...
if (ini_get('max_execution_time') < 300) {
	...
	echo "<script>window.location='../forms/frm_home.php?error=1'</script>";
	...
	echo "<script>window.location='../forms/frm_home.php?error=2'</script>";
	...
	echo "<script>window.location='../forms/frm_home.php?error=3'</script>";
